...
public class MascotaVO {
    ...
    public MascotaVO(int id, String nombre, String especie, String raza, String documentoDueno) {
        this.id = id;
        this.nombre = nombre;
    ...
    public MascotaVO(String nombre, String especie, String raza, String documentoDueno) {
        this.nombre = nombre;
        this.especie = especie;
        this.raza = raza;
        this.documentoDueno = documentoDueno;
